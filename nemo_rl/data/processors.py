...
def math_data_processor(
    ...
    if (
        ...
        == user_message["token_ids"][0]
        == user_message["token_ids"][1]
    ):
    ...
    assert (
        ...
        "Still encountering double-bos. Please raise your tokenizer in https://github.com/NVIDIA-NeMo/RL/issues/855."
    )
