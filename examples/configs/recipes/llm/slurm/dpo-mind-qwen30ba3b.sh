#!/bin/bash
# SLURM batch script for NeMo RL Multi-Node DPO Training
...
#SBATCH --output=slurm_logs/nemo-rl-dpo-mind-qwen30ba3b-%j.out
#SBATCH --error=slurm_logs/nemo-rl-dpo-mind-qwen30ba3b-%j.err

# Create a script that will be executed on each node via srun (in shared location)
cat > /home/pmartins/nemo-rl/examples/configs/recipes/llm/slurm/slurm_multinode_worker_dpo_qwen30ba3b.sh << 'WORKER_SCRIPT_EOF'
#!/bin/bash
...
chmod +x /home/pmartins/nemo-rl/examples/configs/recipes/llm/slurm/slurm_multinode_worker_dpo_qwen30ba3b.sh

echo "=== Starting Multi-Node DPO SLURM Job ==="
echo "Job ID: $SLURM_JOB_ID"
echo "Nodes: $SLURM_JOB_NUM_NODES"
echo "Node list: $SLURM_JOB_NODELIST"

# Launch the worker script on all nodes simultaneously using srun
srun --ntasks-per-node=1 /home/pmartins/nemo-rl/examples/configs/recipes/llm/slurm/slurm_multinode_worker_dpo_qwen30ba3b.sh

echo "=== Multi-Node DPO Job Completed ==="