...
#SBATCH --output=slurm_logs/nemo-rl-sft-mind-qwen30ba3b-thinking-mind-expert-%j.out
#SBATCH --error=slurm_logs/nemo-rl-sft-mind-qwen30ba3b-thinking-mind-expert-%j.err
...
if [ "$NODE_RANK" -eq 0 ]; then
    ...
    uv run python examples/run_sft.py \
        --config examples/configs/recipes/llm/sft-mind-megatron-qwen30ba3b-thinking-mind-expert.yaml \
        2>&1 | tee -a "$LOG_FILE"
